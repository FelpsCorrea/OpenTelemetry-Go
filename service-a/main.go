...
import (
	...
	"github.com/FelpsCorrea/OpenTelemetry-Go/service-a/internal/infra/otel"
	"github.com/FelpsCorrea/OpenTelemetry-Go/service-a/internal/infra/web/handlers"
...
func main() {
	...
	r.Get("/weather/{cep}", handlers.GetWeatherHandler)
